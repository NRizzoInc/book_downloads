...
# http://lovefreenovels.com/Newest-Books/The_Silver_Mask__Magisterium__4_/page.html
# http://lovefreenovels.com/Newest-Books/The_Silver_Mask__Magisterium__4_/page_2.html
# http://lovefreenovels.com/Newest-Books/The_Silver_Mask__Magisterium__4_/page_58.html --last page
url_base = "http://lovefreenovels.com/Newest-Books/The_Silver_Mask__Magisterium__4_/page"
url_list = []

# Parse through all urls and add them to list (goes up to 58)
for i in range(1, 59):
...
for url_num, url in enumerate(url_list, start=1):
    ...
    beg_phrase = "Written By: Holly Black & Cassan\n"
    end_phrase = "Total 58 Pages: Previous"
...
name_of_txt_file = "The Silver Mask (Magisterium #4).txt"
path_to_txt_file = os.path.join(path_to_script_dir, '..\SavedBooks\Magisterium', name_of_txt_file)
