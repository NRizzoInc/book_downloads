...
#https://www.bookscool.com/en/The-Colossus-Rises-421374/1
url_base = "https://www.bookscool.com/en/The-Colossus-Rises-421374"
url_list = []

# Parse through all urls and add them to list (goes up to 22)
for i in range(1, 23): 
    if (i == 1):
        full_url = url_base + "/1"
    else:
...
for url_num, url in enumerate(url_list, start=1):
    ...
    # print(text)
    if (url_num == 1):
        beg_phrase = "ABOUT THE PUBLISHER"
    else:
        beg_phrase = "22\n\n\n\n\nThe Colossus Rises"

    if (url_num == 1):
        end_phrase = " No Previous Page"
    else:
        end_phrase = " « Previous Page"
...
name_of_txt_file = "Colossus-Rises.txt"
path_to_txt_file = os.path.join(path_to_script_dir, '..\SavedBooks\SevenWonders', name_of_txt_file)
