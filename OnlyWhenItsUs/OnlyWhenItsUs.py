...
# https://www.reads2020.com/romance/6343/6343.html -- pg 1
# https://www.reads2020.com/romance/6343/6343_2.html -- pg2
# https://www.reads2020.com/romance/6343/6343_76.html -- last page
url_base = "https://www.reads2020.com/romance/6343/6343"
url_list = []
...
for url_num, url in enumerate(url_list, start=1):
    ...
    #print(text)
    if url_num == 1:
        beg_phrase = f"Only When It's Us\nAuthor: Chloe Liese"
    else:
        beg_phrase = f"Only When It's Us({url_num})\nAuthor: Chloe Liese"
    end_phrase = "Total 76 Pages:"
...
name_of_txt_file = "Only When It's Us.txt"
path_to_txt_file = os.path.join(path_to_script_dir, "..", "SavedBooks", "OnlyWhenItsUs", name_of_txt_file)
