...
# http://6booksy.com/books/Age-of-Swords/page_1.html
# http://6booksy.com/books/Age-of-Swords/page_2.html
url_base = "http://6booksy.com/books/Age-of-Swords/page_"
url_list = []

# Parse through all urls and add them to list (goes up to 130)
...
for url_num, url in enumerate(url_list, start=1):
    ...
    beg_phrase = "Written By: Michael J. Sullivan\n"
    end_phrase = "\n\nprevious"
...
name_of_txt_file = "Age of Swords (Legends of the First Empire #2).txt"
