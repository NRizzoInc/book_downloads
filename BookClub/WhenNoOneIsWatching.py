...
# https://www.reads2020.com/mystery_thriller/7315/7315.html
# https://www.reads2020.com/mystery_thriller/7315/7315_4.html
# https://www.reads2020.com/mystery_thriller/7315/7315_68.html -- last page
url_base = "https://www.reads2020.com/mystery_thriller/7315/7315"
url_list = []

# Parse through all urls and add them to list (goes up to 68)
for i in range(1, 69):
...
for url_num, url in enumerate(url_list, start=1):
    ...
    beg_phrase = "Author: Alyssa Cole\n"
    end_phrase = "Total 68 Pages:"
...
name_of_txt_file = "When No One Is Watching.txt"
